...
new Typewriter('#typewriter', {
  strings: ['Lawrence Clarke', 'Web-developer', 'Data-Analyst'],
  autoStart: true,
  loop: true,
  cursor: "|",
});
...
function scrollup(){
    ...
    // When the scroll higher than 560 viewpoint /height, then the scroll up icon should appear and on clicking should reach top of the page. 
    if(this.scrollY >= 560){
